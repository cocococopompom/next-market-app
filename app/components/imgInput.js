...
const ImgInput = (props) => {
    ...
    const handleClick = async() => {
        try{
            ...
            data.append("upload_preset", "xhzu6j8n")
            data.append("cloud_name","doc4zkliy")
            const response= await fetch("https://api.cloudinary.com/v1_1/doc4zkliy/image/upload", {method: "POST", body: data})
